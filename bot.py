...
from plugins.commands import premium_expiry_reminder_loop  # Import the background loop
...
class Bot(Client):
    ...
    async def start(self):
        ...
        # Start the background subscription expiry & reminder task safely upon boot
