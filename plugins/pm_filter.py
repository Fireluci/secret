...
async def auto_filter(client, msg, spoll=False):
    ...
    if not spoll:
        ...
        if len(message.text) < 100:
            ...
            find = search.split(" ")
            search = ""
            removes = "in, series, thriller, 4k, ott, esub, webseries, language, hd, hollywood, and, &, bollywood, dub, mystery, anime, dubbed, file, web, download, movie, film, netflix, link, subtitles".split(", ")
            for x in find:
