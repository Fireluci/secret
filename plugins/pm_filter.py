...
from info import *
from utils import connected_group, get_size, is_subscribed, search_gagala, temp, get_settings
...
@Client.on_callback_query(filters.regex(r"^next") & connected_group)
...
@Client.on_callback_query(filters.regex(r"^spolling") & connected_group)
...
@Client.on_callback_query(connected_group)
